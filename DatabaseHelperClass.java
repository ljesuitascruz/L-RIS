...
public class DatabaseHelperClass extends SQLiteOpenHelper {
    ...
    //Add Employee Data
    public void addEmployee(ModelClass employeeModelClass){
    ...
    public List<ModelClass> getEmployeeList(){
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                storeEmployee.add(new ModelClass(id,name,email));
    ...
    public void updateEmployee(ModelClass employeeModelClass){
        ContentValues contentValues = new ContentValues();
        contentValues.put(DatabaseHelperClass.NAME,employeeModelClass.getName());
        contentValues.put(DatabaseHelperClass.EMAIL,employeeModelClass.getEmail());
        sqLiteDatabase = this.getWritableDatabase();
